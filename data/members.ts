...
export const alumniMembers: Alumni[] = [
  ...
  { id: "ran_shulkind", name: "Ran Shulkind", imageSrc: "/alumni/ran_shulkind.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "guy_zohar", name: "Guy Zohar", imageSrc: "/alumni/guy_zohar.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "smadar_david", name: "Smadar David", imageSrc: "/alumni/smadar_david.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "kfir_ben_haim", name: "Kfir Ben Haim", imageSrc: "/alumni/kfir_ben_haim.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "roy_saar", name: "Roy Saar", imageSrc: "/alumni/roy_saar.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "or_elias", name: "Or Elias", imageSrc: "/alumni/or_elias.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "amir_day", name: "Amir Day", imageSrc: "/alumni/amir_day.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "dan_riesel", name: "Dan Riesel", imageSrc: "/alumni/dan_riesel.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "naama_dayan", name: "Naama Dayan", imageSrc: "/alumni/naama_dayan.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "yuval_peless", name: "Yuval Peless", imageSrc: "/alumni/yuval_peless.png", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "ben_cohen", name: "Ben Cohen", imageSrc: "/alumni/ben_cohen.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "ron_karat", name: "Ron Karat", imageSrc: "/alumni/ron_karat.png", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "meir_komet", name: "Meir Komet", imageSrc: "/alumni/meir_komet.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "ofek_kirzner", name: "Ofek Kirzner", imageSrc: "/alumni/ofek_kirzner.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "dor_tirosh", name: "Dor Tirosh", imageSrc: "/alumni/dor_tirosh.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "eran_milo", name: "Eran Milo", imageSrc: "/alumni/eran_milo.png", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
  { id: "orian_vakil", name: "Orian Vakil", imageSrc: "/placeholder-user.jpg", linkedinUrl: "", cohort: "Inception Sprint", track: "founder" },
];
